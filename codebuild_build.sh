...
if [ -n "$environment_variable_file" ]; then
...
if $mount_src_dir_flag; then
	docker_command+=' -e "MOUNT_SOURCE_DIRECTORY=TRUE"'
fi

if $docker_privileged_mode_flag; then
